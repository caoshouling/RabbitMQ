...
public class RabbitMQConfig {
	...
	public ConnectionFactory connectionFactory(){
		...
		connectionFactory.setAddresses("192.168.100.20:5672");
	...
	/**
	 * 注意，这个connectionFactory名称必须和上面的connectionFactory()一致，不然注入不了。
    ...
    public SimpleMessageListenerContainer messageContainer(ConnectionFactory connectionFactory) {
    	...
    	container.setDefaultRequeueRejected(false);//是否重回队列，一般是false
    	container.setAcknowledgeMode(AcknowledgeMode.MANUAL);//自动签收
